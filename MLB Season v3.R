...
regular_season$team_name <-
  case_when(
    ...
    regular_season$team == "ATHAthletics" ~ "Las Vegas Athletics",
...
regular_season$team_abbrev <-
  case_when(
    ...
    regular_season$team == "ATHAthletics" ~ "LV",
...
pub_regular_season <- regular_season[c(1:4, 9, 5:6, 10, 7:8, 11, 14:15, 16:18)]
...
colnames(pub_regular_season) <- c("Team Name", "Team Abbreviation", "League", "Division", 
                                  ...
                                  "Expected Losses", "Actual vs Expected",
                                  "Projected Wins", "Projected Losses")

View(pub_regular_season)

wb <- wb_workbook(creator = "Richard Ian Carpenter",
                  title = paste0(mlb_season, " MLB Season ", today()))

wb$add_worksheet(sheet = paste0(mlb_season, " Regular Season"))

wb_save(wb,
        file = paste0("C:/Users/Home_PC/Documents/R Scripts/", mlb_season, " MLB Season ", today(), ".xlsx"),
        overwrite = TRUE)

write_xlsx(pub_regular_season,
           file = paste0("C:/Users/Home_PC/Documents/R Scripts/", mlb_season, " MLB Season ", today(), ".xlsx"),
           sheet = paste0(mlb_season, " Regular Season"),
           col_widths = "auto",
           as_table = TRUE,
           overwrite = TRUE)
